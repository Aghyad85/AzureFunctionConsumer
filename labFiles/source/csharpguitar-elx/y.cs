...
public class y
{
    ...
    [Function("y")]
    public void Run([TimerTrigger("%TIMER_FUNCTION_SCHEDULE%")] TimerInfo myTimer, ILogger log, CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (number % 2 == 0)
                {
                    ...
                    {
                        _logger.LogInformation($"A {fie.GetType()} was thrown.  Was this a handled or unhandled exception?");
